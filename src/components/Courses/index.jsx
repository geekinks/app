...
const allCourses = [
  {
    ...
    description: 'Learn the basics of computing including Word, Excel, and PowerPoint.',
    topics: [
...
export default function Courses() {
  ...
  const filteredCourses = filter === 'All' ? allCourses : allCourses.filter(course => course.category === filter);
  ...
  return (
    ...
    >
      ...
      >
        <Button onClick={() => setFilter('All')} variant={filter === 'All' ? 'contained' : 'outlined'} color="success">
          All
        </Button>
        <Button onClick={() => setFilter('Fundamentals')} variant={filter === 'Fundamentals' ? 'contained' : 'outlined'} color="success">
          Fundamentals
        </Button>
        <Button onClick={() => setFilter('Frontend')} variant={filter === 'Frontend' ? 'contained' : 'outlined'} color="success">
          Frontend
        </Button>
        <Button onClick={() => setFilter('Backend')} variant={filter === 'Backend' ? 'contained' : 'outlined'} color="success">
          Backend
        </Button>
        <Button onClick={() => setFilter('Fullstack')} variant={filter === 'Fullstack' ? 'contained' : 'outlined'} color="success">
          Fullstack
        </Button>
      </Stack>
