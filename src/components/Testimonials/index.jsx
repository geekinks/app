...
const testimonials = [
  ...
  },
  {
    ...
    testimonial:
      "Well deserved to be a mentor as a man of thought and also innovation beyond imagination.",
  },
  {
    ...
    testimonial:
      "There is nothing I can say except to express thanks and appreciation for the work from our mentor in the person of ADAMU M. M (AdamsGeeky). I also learned what is Python and how Python is easier and simpler to communicate with human beings and how to collect and interpret objects using Python.",
  },
  {
    avatar: <Avatar alt="Salma Gazali Abdulhamid" src={<FaceTwoToneIcon />} />,
    name: "Salma Gazali Abdulhamid",
    // occupation: 'Tech Enthusiast',
    testimonial:
      "Having a supportive and knowledgeable mentor can make a big difference in any project or learning experience. His guidance and expertise can really help you to grow and succeed!",
  },
  {
  ...
  },
  {
    ...
    // occupation: 'Tech Innovator',
    testimonial:
      "Their ICT Center is advantageous for our people to explore and unlock their potentialities due to their conducive learning environment, lab resources, and also a well-guided/mentorship instructor and highlighters, for the advancement of our people within and outside the community.",
  },
  {
    avatar: <Avatar alt="Hassan Musa Idris" src={img4} />,
    name: "Hassan Musa Idris",
  ...
  },
  {
    ...
    // occupation: 'Data Scientist',
    testimonial:
      "My mentor was knowledgeable and approachable. He provided well-developed and understandable resources which made the program enjoyable and effective.",
  },
];
    ...
    >
      ...
      >
        ...
        <Typography variant="body1" color="text.secondary">
          At Geekink we take pride in the success and satisfaction of our
          students. Here's what some of our Students had to say about their
          experience with us:
        </Typography>
      </Box>
